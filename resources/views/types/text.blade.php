...
<input type="text" name="acf[{{ $field->key }}]" id="acf-{{ $field->key }}"
...
<textarea name="acf[{{ $field->key }}]" id="acf-{{ $field->key }}"
...
<div class="form-check form-switch">
  <input class="form-check-input" type="checkbox" name="acf[{{ $field->key }}]" value="1"
